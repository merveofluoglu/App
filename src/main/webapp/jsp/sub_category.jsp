...
<script>
  ...
  const addSubCategory = () => {
    ...
    $.ajax({
              url: window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + "/subcategory/add",
              method: "POST",
              data: _data,
  ...
  const removeSubCategory = (id) => {
    $.ajax({
              url: window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + '/subcategory/delete/' + id,
              method: "POST",
              success: function (response) {
                table.destroy();
                FillDatatable();
  ...
  const updateSubCategory = () => {
    ...
    $.ajax({
              url: window.location.pathname.substring(0, window.location.pathname.indexOf("/",2)) + '/subcategory/update',
              method: "POST",
              data: _data,
              success: function (response) {
