...
<div class="container-fluid pt-5 pb-3" style="padding-left: 15px; background-color: #f5f5f5">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span>My Favourites</span></h2>
...
<script>
    ...
    const getMyPosts = () => {
        ...
        $.ajax({
                url: "${pageContext.request.contextPath}/favourite/",
                method: "GET",
                success: function (response) {
                    ...
                    data.forEach( element => {
                        ...
                        isecond.onclick = function() { removeFavourite(element.postId); };
                ...
                error: function (response) {
                    toastr.error(JSON.parse(response.data.responseText).error.message);
                    setTimeout(() => {
    ...
    const removeFavourite = (id) => {
        $.ajax({
                url: '${pageContext.request.contextPath}/favourite/removeByUser/' + id,
                method: "POST",
                success: function (response) {
