...
public class GetUserbySurnameDAO extends AbstractDAO {

    private static final String STATEMENT = "SELECT * FROM users WHERE surname = ?";
     ...
     */
    protected GetUserbySurnameDAO(Connection con) {
        super(con);
    }
