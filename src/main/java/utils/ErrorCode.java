...
public enum ErrorCode {
    ...
    INVALID_EMAIL_ADDRESS(-109, HttpServletResponse.SC_BAD_REQUEST, "Invalid email address credential"),
    INVALID_PASSWORD(-110, HttpServletResponse.SC_BAD_REQUEST, "Invalid password credential"),
    USER_NOT_FOUND(-111, HttpServletResponse.SC_NOT_FOUND, "User not found"),
    BADLY_FORMATTED_JSON(-112,  HttpServletResponse.SC_BAD_REQUEST, "JSON format is invalid"),
